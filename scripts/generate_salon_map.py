...
<title>Salon des Sons — 19,810 アーティストの音楽宇宙地図 / 音楽発見アトラス</title>
<meta name="description" content="まだ知らない、 でもきっと好きになる音楽。 1,269 アーティストの個人コレクションを起点に Last.fm + Wikipedia + MusicBrainz の類似性で 19,810 作家 × 42,744 関連に拡張、ワンクリックで YouTube 即試聴できるインタラクティブ音楽宇宙地図。レベルアップで未踏領域が解放されるゲーミフィケーション付き。">
<meta name="keywords" content="音楽発見,類似アーティスト,音楽セレンディピティ,music discovery,similar artists,音楽宇宙地図,artist map,music graph,WebGL,Last.fm,MusicBrainz,Wikipedia,Yoasobi,Helloween,Tenhi,Brian Eno,Yuki Kajiura,Joe Hisaishi,おすすめ音楽,アルバム推薦,music recommendation,interactive music map,音楽探索,music exploration,Salon des Sons,音の客間">
<meta name="author" content="yuichi916 / Views Engineer">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
<meta name="theme-color" content="#0a0814">
<meta name="application-name" content="Salon des Sons">
<meta name="apple-mobile-web-app-title" content="Salon des Sons">

<link rel="canonical" href="https://yuichi916.github.io/salon.html">
<link rel="alternate" hreflang="ja" href="https://yuichi916.github.io/salon.html">
<link rel="alternate" hreflang="x-default" href="https://yuichi916.github.io/salon.html">
...
<meta property="og:site_name" content="Salon des Sons · Music Universe">
<meta property="og:title" content="Salon des Sons — 19,810 アーティストの音楽宇宙地図">
<meta property="og:description" content="まだ知らない、 でもきっと好きになる音楽。 Last.fm + Wikipedia + MusicBrainz で繋いだ 19,810 アーティスト × 42,744 関連を WebGL で可視化。クリック即試聴 + レベル解放のゲーミフィケーション。">
<meta property="og:url" content="https://yuichi916.github.io/salon.html">
<meta property="og:image" content="https://yuichi916.github.io/assets/og-image.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Salon des Sons — 19,810 アーティストの音楽宇宙地図">
...
<meta name="twitter:title" content="Salon des Sons — 19,810 アーティストの音楽宇宙地図">
<meta name="twitter:description" content="まだ知らない、 でもきっと好きになる音楽。 19,810 アーティスト × 42,744 関連の WebGL 音楽地図。クリックで即試聴。">
<meta name="twitter:image" content="https://yuichi916.github.io/assets/og-image.png">

<!-- JSON-LD: WebApplication + WebSite + Person + BreadcrumbList -->
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      "@id": "https://yuichi916.github.io/salon.html#webapp",
      "name": "Salon des Sons — 音楽宇宙地図",
      "alternateName": ["音の客間", "Music Discovery Atlas"],
      "url": "https://yuichi916.github.io/salon.html",
      "description": "1,269 アーティストの個人コレクションを起点に、Last.fm・Wikipedia・MusicBrainz の類似性で 19,810 作家 × 42,744 関連に拡張したインタラクティブ音楽宇宙地図。",
      ...
      "creator": {"@id": "https://yuichi916.github.io/#person"},
      "publisher": {"@id": "https://yuichi916.github.io/#person"},
      "featureList": [
        "19,810 アーティスト × 42,744 類似関連の WebGL 可視化",
        "ジャンル別 / 未訪問のみ / 即試聴可のみ フィルター",
        "ワンクリック YouTube 即試聴 (Premium 広告なし対応)",
        "Amazon ASIN 直リンク (推奨アルバムへ)",
        "6 レベル + 10 実績のゲーミフィケーション",
        "似た作家チップ (5-10 関連作家を popover 表示)"
      ]
    },
    {
      "@type": "WebSite",
      "@id": "https://yuichi916.github.io/#website",
      "name": "Views Engineer",
      "alternateName": "Salon des Sons",
    ...
    {
      "@type": "Person",
      "@id": "https://yuichi916.github.io/#person",
      "name": "yuichi916",
      "alternateName": "Views Engineer",
      "url": "https://yuichi916.github.io/",
      "sameAs": [
        "https://twitter.com/ViewsEngineer",
        "https://twitter.com/ZundamonAILab"
      ]
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {"@type": "ListItem", "position": 1, "name": "Views Engineer", "item": "https://yuichi916.github.io/"},
        {"@type": "ListItem", "position": 2, "name": "Salon des Sons", "item": "https://yuichi916.github.io/salon.html"}
      ]
    }
  ]
}
...
.universe-frame{position:relative;width:100%;height:88vh;
  background:var(--night);border:1px solid rgba(212,160,80,.18);
  border-radius:8px 8px 0 0;overflow:hidden;
  box-shadow:0 -4px 30px rgba(212,160,80,.08), 0 16px 60px rgba(0,0,0,.6);}
.universe-frame iframe{width:100%;height:100%;border:0;display:block;
  background:var(--night);}
@media(max-width:780px){.universe-frame{height:80vh}}
...
.chip-tip{position:fixed;pointer-events:none;z-index:9999;
  background:rgba(15,12,22,.98);border:1px solid var(--amber);
  border-radius:6px;padding:8px 14px;
  font-family:"Shippori Mincho",serif;color:var(--paper);
  font-size:13px;font-weight:700;letter-spacing:.04em;
  box-shadow:0 10px 28px rgba(0,0,0,.85), 0 0 16px rgba(212,160,80,.18);
  backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);
  white-space:nowrap;opacity:0;transition:opacity .1s;
  transform:translate(-50%, -100%);max-width:340px;
  display:none;}
.chip-tip.show{display:block;opacity:1;}
.chip-tip .chip-tip-album{display:block;font-family:"Cormorant Garamond",serif;
  font-style:italic;font-weight:400;font-size:11.5px;color:var(--amber-soft);
...
<section class="hero" id="top">
  <div class="hero-content">
    ...
    <p class="hero-sub serif">
      19,810 アーティスト × 42,744 関連 ── あなた の 好き な 音楽 の<br>
      <em>隣</em> に いる、 まだ 出会っていない 作家 を 探す 探索 地図。<br>
      クリック で スコア が 上がり、 マイナーな 領域 が 解放 される。
    </p>
    <div class="hero-actions">
      <a href="#universe" class="hero-btn primary">▼ 音楽宇宙へ降りる</a>
      <a href="universe.html" class="hero-btn secondary" target="_blank" rel="noopener">全画面で開く ↗</a>
    </div>
  </div>
</section>

<section class="sec" id="universe" style="padding:24px 0 0;border-top:none">
  <div class="sec-inner" style="max-width:1400px;padding:0 18px">
    <div class="sec-eyebrow eng" style="margin-bottom:12px">Music Universe · 19,810 アーティスト</div>
    <h2 class="sec-title serif" style="font-size:clamp(28px,3.4vw,46px);margin-bottom:6px">クリック で <em>探索</em>、 出会い で <em>解放</em>。</h2>
    <p class="sec-lead" style="margin-bottom:18px;color:var(--paper-dim);font-size:14px">
      未訪問のノードは鮮やか、 訪れた作家はくすむ。 マイナーな領域は Lv が上がるまで 「？」 として隠されている。 「つぎへ →」 で関連を辿り、 「🎲」 で未知へ飛ぶ。
    </p>
  </div>
  <div class="universe-frame">
    <iframe src="universe.html?embed=1" id="universeFrame"
      title="Music Universe — 19,810 artist discovery graph"
...
<section class="sec" id="map">
  <div class="sec-inner">
    <div class="sec-eyebrow eng">Curator's Index · サロン主の見立て</div>
    <h2 class="sec-title serif">19,810 の 宇宙 の、 <em>1,269 の 起点</em>。</h2>
    <div class="sec-lead">
      <p>音楽宇宙 の <em>アンカー</em> となっている 個人コレクション の 内訳。 14 の 入口 を <strong>静謐 ↔ 激情</strong> × <strong>器楽 ↔ 声楽</strong> の 軸 で 配置 し、 60+ サブクラスタ に 分類。 アーティスト を クリック で 推奨盤 と 「<strong>似た作家</strong>」 が 出る (●印 = サロン内 / ↗ = 未知 へ)。 ここで 道筋 を つけてから <a href="#universe">↑ 宇宙</a> に戻ると、 関連の網が 見えてくる。</p>
    </div>
...
// Lightweight floating tooltip used on chip hover (popover is click-only)
let _chipTipEl = null;
function showChipTip(el, display, album, desc){
  if (!_chipTipEl){
    _chipTipEl = document.createElement('div');
    _chipTipEl.className = 'chip-tip';
    document.body.appendChild(_chipTipEl);
  }
  const albumLine = album ? `<span class="chip-tip-album">推奨盤 · ${album.title}</span>` : '';
  _chipTipEl.innerHTML = `${display}${albumLine}`;
  const r = el.getBoundingClientRect();
  _chipTipEl.style.left = (r.left + r.width / 2) + 'px';
  _chipTipEl.style.top  = (r.top - 8) + 'px';
  _chipTipEl.classList.add('show');
}
function hideChipTip(){
  if (_chipTipEl) _chipTipEl.classList.remove('show');
}
...
function openSubgroup(slug, idx){
  ...
  sg.artists.forEach(a => {
    ...
    // Hover only shows a lightweight floating tooltip (chip popover is
    // pinned-on-click only — keeps the chip grid readable).
    span.addEventListener('mouseenter', () => showChipTip(span, display, album, desc));
    span.addEventListener('mouseleave', hideChipTip);
