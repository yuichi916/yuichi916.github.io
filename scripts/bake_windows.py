...
GROUPS: list[tuple[str, list[tuple]]] = [
    ...
    ("フリーゲーム — 投稿サイト", [
        ("PLiCy", "https://plicy.net/User/150013", "/User/150013",
         "フリーゲーム投稿サイト PLiCy の作者ページ。公開している作品はここに並びます。",
         None, ("作者ページ", "ゆうさん — 公開中 1 作品")),
        ("正解の外側", "https://plicy.net/GamePlay/234398", "/GamePlay/234398",
         "PLiCy 版の『正解の外側』。ブラウザでそのまま遊べます。",
         None, ("2026-08-02 投稿", "全15話・フルボイスのサウンドノベル")),
        ("百の悪行", "https://freegame-mugen.jp/adventure/game_15309.html", "/adventure/game_15309",
         "フリーゲーム夢現に投稿した『百の悪行』。アドベンチャー・ノベル枠。",
         None, ("フリーゲーム夢現", "魔王の犯行記録を、勇者が検証する約30分の短編")),
    ]),
    ("コード — 作ったもの", [
