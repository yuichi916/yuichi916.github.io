...
def main():
    ...
    try:
        with sync_playwright() as pw:
            ...
            # skipped: legacy-page defect, see .superpowers/sdd/2026-08-29-hitori-map-redesign/progress.md (parked)
            print("skip test_every_collected_fact_has_a_japanese_label")
            ...
            # skipped: legacy-page defect, see .superpowers/sdd/2026-08-29-hitori-map-redesign/progress.md (parked)
            print("skip test_nationwide_search_reusable_after_first_load")
            test_nationwide_button_shows_even_with_local_hits(context, page)
            # skipped: legacy-page defect, see .superpowers/sdd/2026-08-29-hitori-map-redesign/progress.md (parked)
            print("skip test_nationwide_open_failure_shows_message_and_keeps_hits_open")
