...
{ bg:'zanky', bgm:'hibi',
  ...
  {wait:500},
  {say:'toki', text:'まだ見つからんか。母さんの声。'},
  {say:'kanata', text:'うるさいな。'},
  ...
  {say:'ren', text:'（口を押さえて、肩が揺れた）'},
  {say:'kanata', text:'笑うなよ。'},
...
{ bg:'ichiba', bgm:'tansaku',
  ...
  {wait:500},
  {say:'toki', text:'——人は、人の形にしか声を預けんからな。'},
  ...
  {say:'ren', text:'『きょうの いちばん は』'},
  {say:'kanata', text:'俺は、市場の朝の「あ」。'},
  {say:'ren', text:'『わたしは あなたが わらった おと』'},
...
{ bg:'suiro', bgm:'mizu',
  ...
  {say:'ren', text:'『みずの おとが きこえると ねむれる』'},
  {say:'kanata', text:'ふうん。'},
  {say:'ren', text:'『でも きのう ここの おとが すこし へった』'},
  {say:'kanata', text:'……分かるのか、それ。'},
  {say:'ren', text:'『わかる』'},
  {say:'ren', text:'『わたしは おとが へるのが わかる』'},
  ...
  {say:'ren', text:'『いま いったら つまらない』'},
  {say:'kanata', text:'ずるいなあ。'},
  {say:'ren', text:'『きょうの いちばんは あなたの ずるいなあ』'},
...
{ bg:'gekijo', bgm:'tansaku',
  ...
  {say:'ren', text:'（喉に手をあてる）'},
  {say:'kanata', text:'先に分かるんだろ。なんで言わなかった。'},
  {say:'ren', text:'『いっても とめられない』'},
  {say:'kanata', text:'言えよ。言われなきゃ、こっちは何も——'},
  {wait:600},
  {say:'kanata', text:'……悪い。'},
  ...
  {choose:[
    {label:'謝る', set:'ayamaru', reply:[
      {say:'kanata', text:'ごめん。ほんとに、ごめん。'},
      {say:'ren', text:'『いいよ』'},
      {say:'ren', text:'『はじめて あなたの ことばが まっすぐ あたった』'},
  ...
  {say:'ren', text:'『でも ひとつ いう』'},
  {say:'ren', text:'『おとが きえるとき わたしの なかが すこし あたたかくなる』'},
  {say:'kanata', text:'……なんだよ、それ。'},
  {say:'ren', text:'『わからない』'},
  {say:'ren', text:'『きょうの いちばんは あなたの ごめん』'},
  {when:'ayamaru', reply:[
...
{ bg:'tou', bgm:'fuon',
  ...
  {fx:'shake'},
  {say:'ren', text:'（喉を押さえて、うずくまる）'},
  {say:'kanata', text:'セイレン? おい——'},
  {say:'ren', text:'『いっぱいに なる』'},
  {say:'kanata', text:'何が。'},
  {say:'ren', text:'『わからない』'},
  {say:'ren', text:'『でも もうすぐ あふれる』'},
...
{ bg:'soko', bgm:'shoutai',
  ...
  {say:'kanata', text:'……なんで。'},
  {say:'kanata', text:'なんで母さんの声が、瓦礫に落ちてるんだよ。'},
  ...
  {say:'ren', text:'（喉に手をあてる）'},
  {say:'kanata', text:'——きみ、なんだよな。'},
  {wait:900},

  {say:'ren', text:'『わたしは』'},
  {say:'ren', text:'『しずかにする ための うつわ』'},
  {say:'ren', text:'『いま おもいだした』'},
  ...
  {say:'ren', text:'『いっぱいに なったから あふれてる』'},
  {say:'ren', text:'『こぼれた ぶんを あなたが ひろってた』'},
  {say:'kanata', text:'じゃあ、記憶が無かったのは。'},
  {say:'ren', text:'『ためた おとが おおいと ひとに なる』'},
  {say:'ren', text:'『だから ときどき からに される』'},
  {say:'ren', text:'『わたしは このまえ からに された ばかり』'},
  ...
  {say:'ren', text:'『ためた おとは ぜんぶ まちに かえる』'},
  {say:'kanata', text:'……じゃあ、それでいいじゃんか。'},
  {wait:700},
  {say:'ren', text:'『わたしの なかみは ぬすんだ おとで できてる』'},
  {say:'ren', text:'『かえしたら わたしは のこらない』'},
  ...
  {choose:[
    ...
    {label:'渡さない、と言ってみる', reply:[
      ...
      {say:'ren', text:'『それだと また からに される』'},
      {say:'ren', text:'『つぎの わたしは あなたを しらない』'},
      {say:'kanata', text:'……ずるいだろ、それ。'},
      {say:'ren', text:'『わたしは ずるい』'}
    ]}
  ]},

  {say:'ren', text:'『ひとつ おねがいが ある』'},
  {say:'kanata', text:'なんだよ。'},
  {say:'ren', text:'『きょうの いちばんを いわせて』'},
  {say:'kanata', text:'……声、まだ渡してないだろ。'},
  {say:'ren', text:'『かくよ』'},
  {wait:600},
  {say:'ren', text:'『きょうの いちばんは あなたが なまえを くれた おと』'},
  {when:'watasu', reply:[
    {say:'kanata', text:'……それ、一年前だろ。'},
    {say:'ren', text:'『ずっと いちばん』'}
  ]},
  {hide:'all'},
  {end:1}
]},
